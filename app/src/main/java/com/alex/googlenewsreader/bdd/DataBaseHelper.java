...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String[] FIELD = {"TITLE","URL","IMAGE","SNIPPET","TAG","ISACTIVE","DATE"};
    ...
    public static final String DB_CREATE_TABLE_NEWS = "CREATE TABLE "+DB_TABLE_NAME+" "+ " ( _ID INTEGER PRIMARY KEY AUTOINCREMENT, "+FIELD[0]+" VARCHAR," +
            FIELD[1]+" VARCHAR,"+FIELD[2]+" VARCHAR,"+FIELD[3]+" VARCHAR,"+FIELD[4]+" VARCHAR,"+FIELD[5]+" INTEGER,"+FIELD[6]+" VARCHAR)";
